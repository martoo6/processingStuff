class Faisceau {
  ...
  void draw() {
    ...
    calculer();
    pointsSurOX();
    quadrilatere(points[1].position(), points[2].position(), inter2[2], inter2[1], color(250, 250, 0, 100));
    quadrilatere(points[1].position(), points[3].position(), inter2[3], inter2[1], color(250, 100, 0, 100));
    quadrilatere(points[2].position(), points[3].position(), inter2[3], inter2[2], color(100, 250, 0, 100));
    triangle3d(points[0].position(), inter1[2], inter1[1], color(250, 250, 0, 100));
    triangle3d(points[0].position(), inter1[2], inter1[3], color(250, 100, 0, 100)); 
    triangle3d(points[0].position(), inter1[3], inter1[1], color(100, 250, 0, 100));
